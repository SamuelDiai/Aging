...
#
#     dict_onehot = {'1747' : {1 : 'Blonde', 2 : 'Red', 3 : 'Light brown', 4 : 'Dark brown', 5 : 'Black',
#                              6 : 'Other', -1 : 'Do not know'},
#                    '1757' : {1 : 'Younger than you are', 2 : 'Older than you are', 3 :'About your age', -1 : 'Do not know'}}
#
...
#     print(temp.columns)
#     temp = temp.drop(columns = ['1747-%s.Do not know' % instance])
#
