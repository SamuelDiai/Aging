...
class BaseModel():
    ...
    def optimize_hyperparameters_fold_(self, X, y, scoring, fold):
        ...
        for inner_fold in range(self.inner_splits):
            ...
            print(list(list_test_folds_id[:inner_fold]))
            print(list(list_test_folds_id[inner_fold + 1:]))
            ...
            print(len(index_train_train))
            print(index_train_train == list(list_test_folds_id[:inner_fold]) + list(list_test_folds_id[inner_fold + 1:]))
