...
print("Starting HC")
dict_not_changed_index, Zdf, initial_dict = AglomerativeClusteringFull(path_input_env_inputed, target_dataset = target_dataset)
...
CreateClustersFromInterestingNodes(list_interesting, linkage_matrix_raw, path_input_env_inputed, path_clusters, target = target_dataset)
