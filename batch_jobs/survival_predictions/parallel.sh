...
datasets=( "CognitiveAllBiomarkers" "BrainAllBiomarkers" "VascularAllBiomarkers" "EyesAllBiomarkers" "HearingTest" "Spirometry" "AnthropometryAllBiomarkers" "HeartAllBiomarkers" "BoneDensitometryOfHeel" "BloodAllBiomarkers" "UrineBiochemestry" "Demographics")
outer_splits=10
inner_splits=9
n_iter=15
n_splits=10
